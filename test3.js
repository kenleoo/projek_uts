...
function main() {
  ...
  // body cylinder
  LIBS.translateY(LitwickBodyClylinder1.POSITION_MATRIX, -0.1);
  LIBS.scaleX(LitwickBodyClylinder1.POSITION_MATRIX, 2.5);
  LIBS.scaleY(LitwickBodyClylinder1.POSITION_MATRIX, 2.5);
  LIBS.scaleZ(LitwickBodyClylinder1.POSITION_MATRIX, 2.5);
