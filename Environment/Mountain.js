export class Mountain {
  ...
  constructor(
    ...
    for (let i = 0; i <= rings; i++) {
      const t = i / rings;
      const r = paraboloidRadius * (1 - t) * 0.75;             // radius mengecil ke bawah
      ...
      for (let j = 0; j <= segments; j++) {
        ...
        // warna ungu gelap 
        const rCol = 0.025 + 0.1 * (1 - t);
        const gCol = 0.125 + 0.0075 * (1 - t);
        const bCol = 0.225 - 0.075 * (1 - t);

        this.vertex.push(x, y, z, rCol, gCol, bCol);
